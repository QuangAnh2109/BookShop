...
public class Home extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Book> books = new BookDAO().getListBookBy(search, companys, categorys, covers);
        request.setAttribute("category", new CategoryDAO().getAllCategory());
        request.setAttribute("company", new CompanyDAO().getAllCompany());
        request.setAttribute("coverType", new CoverTypeDAO().getAllCoverType());
