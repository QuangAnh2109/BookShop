...
public class CompanyDAO extends DBContext{
    public int update(int id, String companyName){
        return executeUpdate("update PublishingCompany set CompanyName='"+companyName+"' where CompanyID="+id);
    }
    
    public int insert(String company) {
        return executeUpdate("insert into PublishingCompany (CompanyName) values('" + company + "')");
    }
