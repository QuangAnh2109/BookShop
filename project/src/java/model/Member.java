...
public class Member {
    ...
    public Member(int id,String accountName, String name, String password, String phoneNumber, String address, int role, ArrayList<CartItem> cart, ArrayList<Order> orderHistory) {
        this.id = id;
        this.accountName = accountName;
        this.name = name;
        this.password = password;
