...
public class MemberDAO extends DBContext{
    public int insert(Member member){
        return executeUpdate("INSERT INTO Member (AccountName,Name,Password,PhoneNumber,Address,Role) VALUES ('"+member.getAccountName()+"',N'"+member.getName()+"','"+member.getPassword()+"','"+member.getPhoneNumber()+"',N'"+member.getAddress()+"',"+member.getRole()+")");
    }
    
    public int update(Member member){
        return executeUpdate("update Member set Name=N'"+member.getName()+"',Password='"+member.getPassword()+"',PhoneNumber='"+member.getPhoneNumber()+"',Address=N'"+member.getAddress()+"',Role="+member.getRole()+" where MemberID="+member.getId());
    }
